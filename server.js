...
const firebaseConfig = {
  apiKey: "AIzaSyCBsjXtkaiPOiix2efVAGeyWp-2LsMHd2s",
  authDomain: "e-com-hack.firebaseapp.com",
  projectId: "e-com-hack",
  storageBucket: "e-com-hack.appspot.com",
  messagingSenderId: "418216112059",
  appId: "1:418216112059:web:57ca43682d045fb90b1e9e",
  measurementId: "G-7HK322S35X"
};
...
app.post('/stipe-checkout', async (req, res) => {
    const session = await stripeGateway.checkout.sessions.create({
        ...
        mode: "payment",
        success_url: `${DOMAIN}/success?section_id={CHECKOUT_SESSION_ID}&{JSON.strigify(req.body)}`,
        cancel_url: `${DOMAIN}/checkout?paymant_fail=true`,
